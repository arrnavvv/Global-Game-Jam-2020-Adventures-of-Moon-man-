...
public class movementController : MonoBehaviour
{
    ...
    private void movementInput()
    {
        if (Input.GetKey(KeyCode.D))
        {
            ...
            if (onTop == false)
                rb.transform.localScale = new Vector2(0.6865464f, 0.6865464f);
            else
                rb.transform.localScale = new Vector2(-0.6865464f, transform.localScale.y);
    ...
    private void GravityChange()
    {
        ...
        {
            Instantiate(popSound, gameObject.transform.position, Quaternion.identity);
